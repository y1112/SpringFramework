...
//	}
	...
	public void buyTicket(final BuyVO buyVO) {
		...
		transactionTemplate2.execute(new TransactionCallbackWithoutResult() {// 익명함수 이용해서 콜백함수 설정

			@Override
			protected void doInTransactionWithoutResult(TransactionStatus arg) {// 메소드 오버라이딩

//				try {
					// card 테이블에 내용 입력하는 과정
